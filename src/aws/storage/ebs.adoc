...
You can attach multiple EBS volumes to a single EC2 instance. You can also attach a single EBS volume to multiple EC2 instances, but with some constraints. This is useful for sharing data between instances.
