...
* *Backup Gateway*: With this option, application servers have access to either block or file storage protocols via a virtual backup software application, installed locally. The storage volume appears to the client as a virtual tape library, but it's actually just another S3 abstraction.
