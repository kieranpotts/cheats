...
DRS can recover applications from physical infrastructure, VMware, vSphere, Hyper-V, and even other (non-AWS) clouds. You can also use DRS for disaster recovery from AWS itself, eg. to recover from failures in one region to another.
