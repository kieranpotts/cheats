...
The Personal Health Dashboard also provides proactive notification of planned events that may impact your resources, and provides guidance on how to prepare for and respond to these scheduled events.
