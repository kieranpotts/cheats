...
It sets up the governance, compliance, and security guardrails for you. It
integrates with other services and features to setup the environment for you,
including:
...
* AWS CloudFormation
* AWS Service Catalog
* IAM Identity Center (formerly AWS Single Sign-On (SSO))
