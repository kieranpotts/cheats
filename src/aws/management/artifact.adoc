...
AWS Artifact has some very useful information if you are building a solution that has high security compliance requirements, like a PCI-compliant solution.
