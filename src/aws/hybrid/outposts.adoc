...
With an Outpost, you can actually deploy VPCs across both your public and private cloud services, and you can run things like EC2 instances directly on your own hardware.
