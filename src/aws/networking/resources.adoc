...
High availability can be achieved by launching redundant resources across
different availability zones.

To launch an EC2 instance, go to *EC2* > *Launch instance*. Give the instance a
name, choose a system image, instance type, and create a public-private key pair
(if you do not already have one you can reuse).

image::../_/launch-ec2-instance.png[]

Under *Network settings*, choose your VPC, and then choose the subnet you want
to launch the instance into. For public instances, you want to choose the option
