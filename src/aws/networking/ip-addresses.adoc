...
You are not charged for _using_ elastic IP address, but you are charged for
_not using_ them. This is indented to discourage hoarding of public IPv4
addresses, which are in short supply.
