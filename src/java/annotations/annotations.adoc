...
compiler or runtime. Annotations don't change how the program works, they just
provide extra information about the program to the environment that will run it.
...
For example, a great deal of the Spring framework is driven by annotations. So
more likely you will use framework-specific annotations rather than Java ones or
your own ones.
