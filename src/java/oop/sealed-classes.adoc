...
sealed class can be extended but only by a fixed set of classes. There was a way
of doing this before, but Java 17 made it easier by adding the `sealed` modifier
