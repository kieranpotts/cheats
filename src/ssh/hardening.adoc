...
For better security, root access and password authentication should be disabled on web servers.

.See also
[NOTE]
====
For additional protection against SSH brute-force attacks, consider using link:../security/fail2ban.adoc[Fail2Ban].
====
