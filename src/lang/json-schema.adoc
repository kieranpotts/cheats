...
* The official JSON Schema website has a https://tour.json-schema.org/[Tour of JSON Schema] that provides an interactive interface to learn the basics of JSON Schema.
