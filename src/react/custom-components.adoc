...
explicitly calling the function, we pass a JSX-representation of the component
to `ReactDOM.render`:
...
This is all you need to create a full-page React app. Here's a complete page
rendered as a single React component:
